                            ...
                            <div class="card border-left-success shadow h-400 py-2" style="background-color: purple; width: 330px; height: 320px;">
                                <div class="card-body" style="text-align: center;">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-white text-uppercase mb-4">
                                                <h2><strong>Total Tempat Tidur</strong></h2></div>
                                                <br><br>
                                        </div>
                                        <center>
                                        <div class="col-auto">
                                        ...
                                        <div class="h4 mb-0 font-weight-bold text-white">{{ count($tempat) }} Buah</div>
                                    </div>
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-md-16 mb-12">
                            <div class="card border-left-success shadow h-400 py-2" style="background-color: purple; width: 330px; height: 320px;">
                                <div class="card-body" style="text-align: center;">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-white text-uppercase mb-4"><h2><strong>Tempat Tidur Terpakai</strong></h2>
                                            </div>
                                            <br><br>
                                        </div>
                                        <center>
                                        <div class="col-auto">
                                            <i class="fas fa-ban fa-4x text-white"></i>
                                        </div><br><br>
                                        </center>
